    ...
    "paths": {
        "/auth/change-password": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid request: passwords are required and must be at least 6 characters",
                        "schema": {
        ...
        "/auth/profile": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "userID, email, username",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/register": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid request body: validation error details",
                        "schema": {
                            "$ref": "#/definitions/internal_handler.ErrorResponse"
                        }
                    },
    ...
    "definitions": {
        ...
        "internal_handler.LoginResponse": {
            ...
            "properties": {
                ...
                "refresh_token": {
                    "type": "string",
                    "example": "1XhvR1bCnUq1UquqTbikKP6vz36-_Ht7dvkSd7P8NTA="
                },
                "token_type": {
                    "type": "string",
                    "example": "Bearer"
